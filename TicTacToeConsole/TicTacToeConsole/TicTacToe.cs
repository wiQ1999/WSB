...
{
	class TicTacToe : Board, IRules
	{
		public int CurrentPlayer { get; set; }

		public TicTacToe(Player a_PlayerKOLKO, Player a_PlayerKRZYZYK) : base(a_PlayerKOLKO, a_PlayerKRZYZYK)
		{
		...
		public void StartGame()
		{
			...
			while (!_bQuitGame)
			{
				...
				while (CheckResult())
				{
					...
					//insert graczy wraz zmozliwoscia wyjscia
				}
			}
		}
		...
		{
			Console.WriteLine("KOLKOKRZYZYK");
